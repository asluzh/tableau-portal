...
(function() {
  ...
  var $tab_CustomMarkContextMenuEvent = global.tab.CustomMarkContextMenuEvent = ss.mkType($asm, 'tab.CustomMarkContextMenuEvent', function(eventName, viz, contextMenuId) {
  ...
  var $tab_VizImpl = global.tab.VizImpl = ss.mkType($asm, 'tab.VizImpl', function(messageRouter, viz, parentElement, url, options) {
    ...
    $raiseCustomMarkContextMenuEvent: function VizImpl$RaiseCustomMarkContextMenuEvent(menuItemId) {
      if (!ss.staticEquals(this.$1$CustomMarkContextMenuField, null)) {
        // TFSID 1287989 will figure out how to get mark data to the CustomMarkContextMenuEvent
        this.$1$CustomMarkContextMenuField(new $tab_CustomMarkContextMenuEvent('custommarkcontextmenu', this.$viz, menuItemId));
      }
    },
    ...
    $handleCustomMarkContextMenuEvent: function VizImpl$HandleCustomMarkContextMenuEvent(notification) {
      this.$raiseCustomMarkContextMenuEvent(notification.get_data().toString());
    },
  ...
  (function() {
    $tableauSoftware_Version.$currentVersion = new $tableauSoftware_Version(2, 9, 0, 'null');
  })();
})();
